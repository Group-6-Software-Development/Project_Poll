...
from routes.course_routes import course_create, courses_get, course_get, course_update, course_delete, course_get_id
...
course_routes = [course_create, courses_get, course_get, course_update, course_get_id, course_delete]
